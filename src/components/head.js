...
export default function Head() {
  return (
    <>
      ...
      <title>AWS Coldplay Music of the Spheres: Perth</title>
      <meta name="description" content="Web page for AWS Coldplay Music of the Spheres: Perth." />
      <meta name="robots" content="noindex, noimageindex, nofollow" />

      {/* Facebook + Open Graph */}
      <meta property="og:locale" content="en_US" />
      <meta property="og:type" content="website" />
      <meta property="og:title" content="AWS Coldplay Music of the Spheres: Perth" />
      <meta property="og:description" content="Web page for the AWS Coldplay Music of the Spheres: Perth" />
      <meta property="og:url" content="https://www.awsrockshere.com/ColdplayPerth" />
      ...
      <meta name="twitter:title" content="AWS Coldplay Music of the Spheres: Perth" />
      <meta name="twitter:description" content="Web page for AWS Coldplay Music of the Spheres: Perth" />
