...
export default function Footer() {
  return (
    <div className="flex flex-col md:flex-row items-center justify-center md:justify-start px-6 py-12 text-sm md:text-base bg-springwood">
      <img className="h-8 md:h-12 pr-0 md:pr-12 mb-8 md:mb-0" src={logoImage} alt="AWS logo" />
      <div className="flex flex-col text-vintage w-full text-center md:text-left md:max-w-3xl opacity-75">
