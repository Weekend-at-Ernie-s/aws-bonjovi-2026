...
export default function Footer() {
  return (
    <div className="flex flex-col md:flex-row h-60 md:h-80 items-center justify-center md:justify-start px-6 py-12 text-sm md:text-base" style={{background: 'linear-gradient(0deg, rgba(0, 0, 0, 0.25) 0%, rgba(0, 0, 0, 0.25) 100%), #F93'}}>
