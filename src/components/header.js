...
export default function Header() {
  return (
    <div className="h-96 md:h-166.5 lg:h-225 bg-bottom sm:bg-cover xl:bg-static-wide  flex flex-col items-center xl:bg-antique-white xl:bg-repeat-y" style={{ backgroundImage: `url(${backgroundImage})` }}>
