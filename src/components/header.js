...
export default function Header() {
  return (
    <div className="h-96 md:max-h-screen md:h-screen bg-bottom bg-cover flex flex-col items-center" style={{ backgroundImage: `url(${backgroundImage})` }}>
      ...
      <div className="text-squid-ink font-light text-5xl md:text-8xl lg:text-9xl">WINE DOWN.</div>
      <div className="text-squid-ink font-light text-5xl md:text-8xl lg:text-9xl">VOLUME UP.</div>
    </div>
  )
}
