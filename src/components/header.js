...
export default function Header() {
  return (
    <div className="h-64 md:h-108 lg:h-[32rem] bg-bottom bg-cover flex flex-col items-center bg-black xl:bg-repeat-y" style={{ backgroundImage: `url(${backgroundImage})` }}>
